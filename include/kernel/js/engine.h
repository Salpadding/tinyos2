#ifndef _KERNEL_JS_ENGINE_H
#define _KERNEL_JS_ENGINE_H

#define DEBUG_JS_ENGINE
#include <size.h>
...
int js_chkargs(jsval_t *, int, const char *);       // Check args validity
int js_truthy(struct js *, jsval_t);                // Check if value is true
